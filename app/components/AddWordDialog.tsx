              ...
              {searchResults.length > 0 && (
                <div className="absolute top-full left-0 right-0 z-50 mt-1 bg-white border rounded-lg shadow-lg overflow-hidden">
                  <div className="px-3 py-1.5 bg-gray-50 border-b">
                    <span className="text-xs font-medium text-gray-500">Found in packs</span>
                  </div>
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="font-arabic text-gray-700">{word.arabic}</span>
                          </div>
                          {word.transliteration && (
                            <div className="text-xs text-gray-500">{word.transliteration}</div>
                          )}
                        </div>
                      </button>
                    ))}
